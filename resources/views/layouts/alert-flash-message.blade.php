...
@if(session('success1'))
<div id="success1-alert" class="alert alert-success alert-dismissable fade show">
    <i class="far fa-check-circle"></i> {{ session('success1') }}
    <button type="button" class="btn-close float-end" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif
...
<script>
    ...
    setTimeout(function() {
        document.getElementById('success1-alert').style.display = 'none';
    }, 10000);
